  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-canvas/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-[1180px] items-center justify-between gap-6 px-6 py-4">
        ...
        <div className="hidden shrink-0 items-center gap-2 nav:flex lg:gap-3">
        ...
        {/* Hamburger, below the nav breakpoint. h-11/w-11 (44px) meets the
            iOS/Android minimum touch-target guidance — the icon itself is
